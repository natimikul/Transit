...
with c2:
    if st.button("📑 Разрешения"):
        ...
        st.session_state.current_report = build_report(st.session_state.active_sheets, cols, filter_by_client=True, allowed_statuses=["В пути", "В сборке, ожидает разрешения"])
